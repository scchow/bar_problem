...
explorations = {'1.000000', '10.000000', '100.000000', '300.000000'};
legendStr = {'1', '10', '100', '300'};
legendStr = arrayfun(@(x) strcat('$Tau = ', x,'$'), legendStr);

% On Desktop
paths = arrayfun(@(x) strcat('../Results/impact_G/tau_', x, '/grace_0'),explorations);
...
title(strcat('Number Learning vs Epochs - Original Impact'));
